...
public class Sql2oIntegrationTest {
    ...
    public void whenTableCreated_thenInsertIsPossible() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_1 VALUES (1, 'tutorials', 'github.com/linggaaskaedo/tutorials')").executeUpdate();
    ...
    public void whenIdentityColumn_thenInsertReturnsNewId() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            query = connection.createQuery("INSERT INTO PROJECT_2 (NAME, URL) VALUES ('REST with Spring', 'github.com/linggaaskaedo/REST-With-Spring')",
                    true);
    ...
    public void whenSelect_thenResultsAreObjects() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_3 (NAME, URL) VALUES ('tutorials', 'github.com/linggaaskaedo/tutorials')").executeUpdate();
            connection.createQuery("INSERT INTO PROJECT_3 (NAME, URL) VALUES ('REST with Spring', 'github.com/linggaaskaedo/REST-With-Spring')").executeUpdate();
    ...
    public void whenSelectAlias_thenResultsAreObjects() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_4 (NAME, URL, creation_date) VALUES ('tutorials', 'github.com/linggaaskaedo/tutorials', '2019-01-01')").executeUpdate();
            connection.createQuery("INSERT INTO PROJECT_4 (NAME, URL, creation_date) VALUES ('REST with Spring', 'github.com/linggaaskaedo/REST-With-Spring', '2019-02-01')").executeUpdate();
    ...
    public void whenSelectMapping_thenResultsAreObjects() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_5 (NAME, URL, creation_date) VALUES ('tutorials', 'github.com/linggaaskaedo/tutorials', '2019-01-01')").executeUpdate();
            connection.createQuery("INSERT INTO PROJECT_5 (NAME, URL, creation_date) VALUES ('REST with Spring', 'github.com/linggaaskaedo/REST-With-Spring', '2019-02-01')").executeUpdate();
    ...
    public void whenSelectCount_thenResultIsScalar() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_6 (NAME, URL, creation_date) VALUES ('tutorials', 'github.com/linggaaskaedo/tutorials', '2019-01-01')").executeUpdate();
            connection.createQuery("INSERT INTO PROJECT_6 (NAME, URL, creation_date) VALUES ('REST with Spring', 'github.com/linggaaskaedo/REST-With-Spring', '2019-02-01')").executeUpdate();
    ...
    public void whenTransactionRollback_thenNoDataInserted() {
        ...
        try(Connection connection = sql2o.beginTransaction()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_12 (NAME, URL) VALUES ('tutorials', 'https://github.com/linggaaskaedo/tutorials')").executeUpdate();
            connection.createQuery("INSERT INTO PROJECT_12 (NAME, URL) VALUES ('REST with Spring', 'https://github.com/linggaaskaedo/REST-With-Spring')").executeUpdate();
            connection.rollback();
    ...
    public void whenTransactionEnds_thenSubsequentStatementsNotRolledBack() {
        ...
        try(Connection connection = sql2o.beginTransaction()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_13 (NAME, URL) VALUES ('tutorials', 'https://github.com/linggaaskaedo/tutorials')").executeUpdate();
            ...
            assertEquals(0, list.size());
            connection.createQuery("INSERT INTO PROJECT_13 (NAME, URL) VALUES ('REST with Spring', 'https://github.com/linggaaskaedo/REST-With-Spring')").executeUpdate();
            list = connection.createQuery("SELECT * FROM PROJECT_13").executeAndFetchTable().asList();
            assertEquals(1, list.size());
    ...
    public void whenTransactionRollbackThenCommit_thenOnlyLastInserted() {
        ...
        try(Connection connection = sql2o.beginTransaction()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_14 (NAME, URL) VALUES ('tutorials', 'https://github.com/linggaaskaedo/tutorials')").executeUpdate();
            ...
            assertEquals(0, list.size());
            connection.createQuery("INSERT INTO PROJECT_14 (NAME, URL) VALUES ('REST with Spring', 'https://github.com/linggaaskaedo/REST-With-Spring')").executeUpdate();
            list = connection.createQuery("SELECT * FROM PROJECT_14").executeAndFetchTable().asList();
            assertEquals(1, list.size());
            //Implicit rollback
        } catch (Exception e) {
    ...
    public void whenLazyFetch_thenResultsAreObjects() {
        ...
        try(Connection connection = sql2o.open()) {
            ...
            connection.createQuery("INSERT INTO PROJECT_16 (NAME, URL) VALUES ('tutorials', 'github.com/linggaaskaedo/tutorials')").executeUpdate();
            connection.createQuery("INSERT INTO PROJECT_16 (NAME, URL) VALUES ('REST with Spring', 'github.com/linggaaskaedo/REST-With-Spring')").executeUpdate();
